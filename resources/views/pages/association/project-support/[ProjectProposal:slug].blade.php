...
<x-layouts.app title="Unterstützung für: {{ $projectProposal->name }}"
               :seo="new SEOData(description: str($projectProposal->description)->limit(100, '...', true), image: $projectProposal->getFirstMediaUrl('main'))">
    @volt
